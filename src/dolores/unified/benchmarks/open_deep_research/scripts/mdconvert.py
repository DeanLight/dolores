...
class ZipConverter(DocumentConverter):
    ...
    def __init__(self, extract_dir: str | None = None):
        """
        Initialize with path to extraction directory.

        Args:
            extract_dir: The directory where files will be extracted. Defaults to the system temp dir.
        """
        import tempfile

        self.extract_dir = extract_dir if extract_dir is not None else tempfile.gettempdir()
